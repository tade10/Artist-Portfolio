...
<!-- ------------------------- NAVBAR ------------------------------------------------------------------------>
  ...
  <section class="content-section container">
    ...
    <h3 class="section-header">You order has been Confirmed!</h3>
    ...
    <div class="cart-items">
      ...
      $query = "INSERT INTO transaction (transaction_id,user_id,item_id,item_name,item_price,item_image,quantity)
                SELECT cart_id,user_id,item_id,item_name,item_price,item_image,quantity
                FROM cart 
