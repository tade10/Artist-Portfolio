...
<!-- ------------------------- NAVBAR ------------------------------------------------------------------------>
  ...
  <section class="content-section container" style="color: white;">
    ...
    <div class="cart-items" >
      ...
      while($row = mysqli_fetch_array($result)){
        ...
        echo "<input class='cart-quantity-input' id='".$class_id."' type='number' value=".$row['quantity'].">";
        echo "<a href='cart_item_remove.php?item_id=".$row['item_id']."&user_id=".$_SESSION["user_id"]."' class='btn btn-remove' role='button'>Remove</a>";
        echo "</div>";
        echo "</div>";
        $class_id = $class_id+1;
        ...
        $item_id_js=$row['item_id'];
        echo "<div class='user_id_js'style='display:none;'>$uid</div>";
        echo "<div class='item_id_js'style='display:none;'>$item_id_js</div>";
      }
      echo "</div>";

      //Total
      echo "<div class='cart-total'>";
      echo "<strong class='cart-total-title' style='color: white;'>Total:</strong>";
      echo "<span class='cart-total-price' style='color: white;'>$".$total_price."</span>";
      echo "</div>";
      echo "<button class='btn purchase-btn btn-purchase' role='button'><a href='cart_checkout.php' style='text-decoration:none; color:white;'>Checkout</a></button>";
